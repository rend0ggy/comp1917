...
void serveHTML(int socket) {
    ...
    const char* message =
        ...
        "<!DOCTYPE html>\n"
        "<html>\n"
        "   <head><title>Haiku by Kobayashi Issa</title></head>\n"
        "   <body style='background:#ddd;margin:0;padding:0;'><div style='width:80\045;padding:10px;align:center;margin-left:10\045;margin-right:10\045;margin-top:50px;font-family:Sans-Serif;background:#fff;border:1px solid #c0c0c0;'><center><h1>Haiku - Kobayashi Issa</h1></center><div style='width:100\045;background:#c0c0c0;height:1px;'></div>\n"
       "<p>Don't weep, insects - <br>Lovers, stars themselves, <br>Must part.</p>"
        " </div></body>\n"
        "</html>\n";
