...
int isLeapYear (int year)  // Primary leap year function
{
...
int main(void) // Main function with the same functionality
{
	...
	if(isLeapYear(year)){ // Every 4th year except those that fall on centuries NOT divisible by 4 is a leap year
